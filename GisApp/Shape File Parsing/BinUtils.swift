    ...
    while mutableFormat.count > 0 {
        ...
        for _ in 0..<max(n,1) {
            ...
            case "c":
                ...
                bytes = data.bytes
            case "b":
                bytes = Int8(o as! Int).data.bytes
            case "h":
                bytes = Int16(o as! Int).data.bytes
            case "i", "l":
                bytes = Int32(o as! Int).data.bytes
            case "q", "Q":
                bytes = Int64(o as! Int).data.bytes
            case "B":
                bytes = UInt8(o as! Int).data.bytes
            case "H":
                bytes = UInt16(o as! Int).data.bytes
            case "I", "L":
                bytes = UInt32(o as! Int).data.bytes
            case "f":
